...
from db.database import init_db, get_all_chats, add_chat
from pathlib import Path

APP_DIR = Path(__file__).resolve().parent.parent  # для ui/*.py
DB_FILE = APP_DIR / "db" / "messages.db"
...
class MessengerUI(QWidget):
    ...
    def init_ui(self):
        ...
        self.btn_chats.setIcon(QIcon(str(ICON_PATH/'chat.png')))
        self.btn_profile.setIcon(QIcon(str(ICON_PATH/"user.png")))
